function tabclinicalpost1norm2pre(varargin)
% tabclinicalpost1norm2pre - create table of the post1 divided by pre value for each measure
%
% Creates a table of the post1 divided by pre value for each clinical measure
% for involved arm only. 
%
...
% Author: Peggy Skelly
% 2013-10-15: created (9:00 - 9:20  = 0.33 hr)
...
[fName, pathName] = getsavenames(fullfile(pwd, 'post1_rel_pre.txt'), 'Save as');
if isequal(fName, 0) || isequal(pathName, 0),
