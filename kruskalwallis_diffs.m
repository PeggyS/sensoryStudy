function kruskalwallis_diffs(varargin)
% kruskalwallis_DIFFS - kruskalwallis test between  difference variables sham(Hs) vs L vs Ha
%
...
measure_list = {'x2pt_dig4',  'monofil_dig4_local',  'vibr_elbw_avg', ...
 	'stkch', 'smobj'};
...
% save
[filename, pathname] = uiputfile('*.txt', 'Save output stats table as', 'kruskalwallis_stats_table.txt');
