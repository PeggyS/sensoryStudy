...
%clinical_PRE_STATS - compute stats on the data in the clinical_data_taller_difference_variables file
%
...
% 						[p,anovatab,stats] = kruskalwallis([sham_data, hi_data, lo_data],{'sham', 'hi', 'lo'}, 'on');
				...
				tmp_tbl = table({measure}, {[p_str '-pre']}, {tbl_gstr}, {i_str}, kw_n, kw_p, hi_n, hi_p, lo_n, lo_p, ...
					'VariableNames', {'measure', 'post', 'glove', 'side', 'friedman_n', 'friedman_p', ...
