function session_minus_sham_stats(varargin)
%SESSION_MINUS_SHAM_STATS - compute stats on the data in the clinical_data_taller_difference_variables file
%
		...
		for i_cnt = 1:length(inv_list)
			...
			if hi_vs_lo_6sess_without_g_n
				...
				if hi_vs_lo_6sess_without_g_p < 0.05;
					disp(['signrank: hi vs lo, all without glove - ' measure, ' ' p_str ' ' i_str ' p=' ...
